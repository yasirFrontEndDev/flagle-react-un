...
import PercentageCountUpUnlimited from './PercentageCountUpUnlimited';
...
const GuessBoxUnlimited = ({guess, index, info, addResultColorLine, showOriginal}) => {
    const green = '#78b159'
    const red = '#dd2e44'
        ...
        <div>
            ...
            >
                ...
                <div style={{width: canvasWidth === 400 ? "17%" : canvasWidth === 360 ? "18%" : "19%",
                    ...
                    {guess && animationsOn && animate &&(<PercentageCountUpUnlimited index={index} end={parseFloat(guess.percentage)} length={animationLength} />)}
...
export default GuessBoxUnlimited